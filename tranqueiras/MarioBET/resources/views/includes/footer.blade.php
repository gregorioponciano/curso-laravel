        ...
        <div class="col-lg-6 col-sm-12">
            <div class="footer-info">
                ...
                <p class="{{ url('/sobre-nos') }}">
                    <strong>MarioBET</strong> é uma comunidade dedicada a oferecer a melhor experiência aos jogadores.
                    Estamos confiantes de que a MarioBET revolucionará a indústria de cassinos online.
        ...
        <div class="col-lg-6 col-sm-12">
            ...
            <div class="footer-right">
                ...
                <div>
                    ...
                    <p>Desenvolvido &#9829; por: <a href="https://www.instagram.com/gpwebsolution/"  style="color: red;">GPWebSolution</a></p>
                </div>
