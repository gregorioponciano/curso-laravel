            ...
            return (function (l) {
                ...
                function (l, h, a) {
                    ...
                    var T = (function (m) {
                        ...
                        function v() {
                            return (
                                (m !== null && m.apply(this, arguments)) || this
                            );
                        }
                        return (
                            ...
                            return (
                                (e.prototype.load = function (t, n, r) {
                                    ...
                                    if (i.loading[t] && i.loading[t].length > 0)
                                        ...
                                        i.loading[t] = [r];
                                        var o = b.createScriptRequest(
                                                i.getPath(t, n)
                                            ),
                                            u = i.receivers.create(function (
                                                p
                                            ) {
                                                if (
                        ...
                        Ge = function (e, t) {
                            return function (n, r) {
                                var i = "http" + (t ? "s" : "") + "://",
                                    ...
                                    p = b.ScriptReceivers.create(function (
                                        _,
                                        g
                                    ) {
                                        s.remove(p),
                    ...
                    var nn = (function () {
                        ...
                        on = (function (e) {
                            ...
                            function t(n, r, i, o, u) {
                                ...
                                return (
                                    (p.initialize =
                                        b.transportConnectionInitializer),
                                    (p.hooks = n),
                                    (p.name = r),
                                    (p.priority = i),
                                    (p.key = o),
                        ...
                        Bt = U(
                            {
                                getSocket: function (e) {
                                    return b.HTTPFactory.createStreamingSocket(
                                        e
                                    );
                                },
                            },
                            ...
                            return (
                                ...
                                (e.prototype.connect = function () {
                                    if (
                                        ...
                                        this.timelineSenderTimer = new Ee(
                                            6e4,
                                            function () {
                                                n.send(t);
                                            }
                            ...
                            return (
                                ...
                                this.events[s] ||
                                    ((this.events[s] = function (N, P) {
                                        d.name === N &&
                                            d.listeners[s] &&
                                            d.listeners[s].forEach(function (
                                                T
                                            ) {
                                                return T(P);
                                            });
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                this.socket.on("reconnect", function () {
                                    Object.values(s.channels).forEach(function (
                                        d
                                    ) {
                                        d.subscribe();
                                    });
