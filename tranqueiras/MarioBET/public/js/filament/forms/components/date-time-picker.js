                ...
                o = function () {
                    ...
                    return {
                        ...
                        weekdaysMin: function (l) {
                            return l
                                ? l.format("dd")
                                : a(d, "weekdaysMin", "weekdays", 2);
                        },
                        weekdaysShort: function (l) {
                            return l
                                ? l.format("ddd")
                                : a(d, "weekdaysShort", "weekdays", 3);
                        },
            ...
            (o.tz = function (l, y) {
                ...
                (o.offsetName = function (l) {
                    var y = this.$x.$timezone || e.tz.guess(),
                        f = u(this.valueOf(), y, { timeZoneName: l }).find(
                            function (_) {
        ...
        var s = t(n),
            i = {
                ...
                relativeTime: {
                    ...
                    s: function (e, a, u, r) {
                        return (
                            "n\xE9h\xE1ny m\xE1sodperc" + (r || a ? "" : "e")
                        );
                    },
                    m: function (e, a, u, r) {
        ...
        return (
            ...
            (t.startOf = function (i, e) {
                var a = this,
                    ...
                    o = function (b, T) {
                        var S = z.w(
                            a.$u ? Date.UTC(a.$y, T, b) : new Date(a.$y, T, b),
                            a
                        );
                    ...
                    d = function (b, T) {
                        ...
                        return z.w(
                            a
                                .toDate()
                                [b].apply(a.toDate("s"), (u ? S : $).slice(T)),
                            a
                        );
                    },
                    l = this.$W,
...
function vi({
    ...
    return {
        ...
        init: function () {
            ...
            let r =
                this.getSelectedDate() ?? A().tz(u).hour(0).minute(0).second(0);
            ((this.getMaxDate() !== null && r.isAfter(this.getMaxDate())) ||
                (this.getMinDate() !== null &&
                    r.isBefore(this.getMinDate()))) &&
                (r = null),
                (this.hour = r?.hour() ?? 0),
            ...
            return !!(
                (this.$refs?.disabledDates &&
                    JSON.parse(this.$refs.disabledDates.value ?? []).some(
                        (o) => (
                            (o = A(o)), o.isValid() ? o.isSame(r, "day") : !1
                        )
                    )) ||
