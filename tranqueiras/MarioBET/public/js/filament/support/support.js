(() => {
        ...
        let r = ln(e),
            ...
            s =
                o === "x"
                    ...
                    : "top";
        return (
            t.reference[i] > t.floating[i] && (s = lr(s)),
            { main: s, cross: lr(s) }
        );
    }
    ...
    function Kt(e) {
        return ((Li(e) ? e.ownerDocument : e.document) || window.document)
            .documentElement;
    }
    function dr(e) {
        return Gt(e)
    ...
    function zr(e) {
        let t = Mt(e),
            n = Ao(e);
        for (; n && Ni(n) && getComputedStyle(n).position === "static"; )
            n = Ao(n);
        return n &&
            (_t(n) === "html" ||
                (_t(n) === "body" &&
    ...
    function $i(e) {
        ...
        return (
            Hn(o || n).direction === "rtl" &&
                (c += jn(n.clientWidth, o ? o.clientWidth : 0) - i),
        ...
        let t = ur(e),
            r =
                ["absolute", "fixed"].includes(Hn(e).position) && Et(e)
                    ...
                    : e;
        return Gt(r)
            ? t.filter((o) => Gt(o) && Wi(o, r) && _t(o) !== "body")
            : [];
    }
    function Xi(e) {
    ...
    var Po = (e, t, n) => Ci(e, t, { platform: zi, ...n }),
        ...
        qi = (e, t) => {
            ...
            return (
                ...
                e.includes("offset") &&
                    n.float.middleware.push(Bo(t.offset || 10)),
                ...
                (
                    ...
                    let K = () => {
                        ...
                        ee = ia(
                            (N) => (N ? W() : K()),
                            (N) => {
                                typeof i._x_toggleAndCascadeWithTransitions ==
                                "function"
                                    ? i._x_toggleAndCascadeWithTransitions(
                                          i,
                                          N,
                                          W,
                                          K
    ...
    function sa(e) {
        e.store("lazyLoadedAssets", {
            ...
            check(o) {
                return Array.isArray(o)
                    ? o.every((i) => this.loaded.has(i))
                    : this.loaded.has(o);
            },
            markLoaded(o) {
                Array.isArray(o)
                    ? o.forEach((i) => this.loaded.add(i))
                    : this.loaded.add(o);
            },
        });
        function t(o) {
        ...
        e.directive("load-css", (o, { expression: i }, { evaluate: s }) => {
            ...
            e.directive(
                "load-js",
                (o, { expression: i, modifiers: s }, { evaluate: c }) => {
                    let u = c(i),
                        h = new Set(s),
    ...
    function po(e, t) {
        for (
            ...
            n &&
            (n === q.ghost || Y(n, "display") === "none" || (t && !xr(n, t)));
        ...
        Kn = {
            ...
            pluginEvent: function (t, n, r) {
                ...
                On.forEach(function (s) {
                    n[s.pluginName] &&
                        (n[s.pluginName][i] &&
                            n[s.pluginName][i](St({ sortable: n }, r)),
        ...
        _prepareDragStart: function (t, n, r) {
            ...
            if (r && !D && r.parentNode === i) {
                ...
                if (
                    ...
                    (u = function () {
                        if (
                            (rt("delayEnded", o, { evt: t }), q.eventCanceled)
                        ) {
                            o._onDrop();
                            return;
                        }
                ...
                n
                    ...
                    : (me(document, "mouseup", r._onDrop),
                      ...
                      o &&
                          ...
                          i.setData && i.setData.call(r, o, D)),
                      we(document, "drop", r),
        ...
        _onDragOver: function (t) {
            ...
            function L(tt) {
                return (
                    ...
                    ((r === D && !D.animated) || (r === n && !r.animated)) &&
                        (Sn = null),
                    !c.dragoverBubble &&
                        !t.rootEl &&
                        r !== document &&
                        (D.parentNode[st]._isOutsideThisEl(t.target),
                        !tt && un(t)),
                    !c.dragoverBubble &&
                        t.stopPropagation &&
                        t.stopPropagation(),
            ...
            if (
                ...
                if (s)
                    return (
                        ...
                        F("revert"),
                        q.eventCanceled ||
                            (fn ? Ie.insertBefore(D, fn) : Ie.appendChild(D)),
                        L(!0)
                    );
    ...
    function _a(e, t, n, r, o, i, s, c) {
        ...
        if (!s) {
            ...
            } else if (u > m + (h * (1 - o)) / 2 && u < g - (h * (1 - o)) / 2)
                return Pa(t);
        }
        return (
            (b = b || s),
            b && (u < m + (h * i) / 2 || u > g - (h * i) / 2)
                ? u > m + h / 2
                    ? 1
                    : -1
                : 0
    ...
    var so = fi(function (e, t, n, r) {
            if (t.scroll) {
                ...
                do {
                    ...
                    var Ce =
                            he &&
                            (Math.abs(L - o) <= s && ae + K < Z) -
                                (Math.abs(B - o) <= s && !!ae),
                        pe =
                            ee &&
                            (Math.abs(F - i) <= s && ue + W < de) -
                                (Math.abs(T - i) <= s && !!ue);
                    if (!Ue[g])
            ...
            if (n) {
                ...
                u(),
                    h &&
                        !h.el.contains(g) &&
                        (s("spill"),
                        this.onSpill({ dragEl: o, putSortable: r }));
            }
        };
    function ho() {}
    ho.prototype = {
    ...
    var La = Object.create,
        ...
        $a = Ei((e) => {
            ...
            function m(l) {
                return (
                    (o(l) ? l.ownerDocument : l.document) || window.document
                ).documentElement;
            }
            function g(l) {
            ...
            function L(l, a) {
                ...
                var E = B(l),
                    ...
                    A = n(E),
                    R = x
                        ? [A].concat(A.visualViewport || [], O(E) ? E : [])
                        : E,
                    P = a.concat(R);
            ...
            function Ht(l, a) {
                ...
                var d = a,
                    ...
                    J = vn(
                        o(je) ? je : je.contextElement || m(l.elements.popper),
                        R,
                        j
                    ),
                    Se = t(ke),
                        ...
                        ye = {
                            ...
                            setOptions: function (ke) {
                                ...
                                if ((Lr(je), nt(I.options.placement) === ue)) {
                                    var J = I.orderedModifiers.find(function (
                                        Fe
                                    ) {
                                        var He = Fe.name;
                                        return He === "flip";
                    ...
                    if (w.content) {
                        ...
                        ie.forEach(function (ce) {
                            ...
                            if (v.state.isVisible)
                                ce.setAttribute(H, ze ? ze + " " + V : V);
                            else {
                                var Ye = ze && ze.replace(V, "").trim();
                                Ye
                                    ? ce.setAttribute(H, Ye)
