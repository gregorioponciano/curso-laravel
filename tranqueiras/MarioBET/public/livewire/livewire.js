...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`,
    ...
    magic(
        "watch",
        (el, { evaluateLater: evaluateLater2, cleanup: cleanup22 }) =>
            (key, callback) => {
    ...
    directive(
        "teleport",
        (el, { modifiers, expression }, { cleanup: cleanup22 }) => {
    ...
    directive(
        "for",
        (el, { expression }, { effect: effect3, cleanup: cleanup22 }) => {
    ...
    directive(
        "on",
        skipDuringClone(
            (el, { value, modifiers, expression }, { cleanup: cleanup22 }) => {
    ...
    var Commit = class {
        ...
        toRequestPayload() {
            ...
            let handleResponse = (response) => {
                ...
                respond();
                this.component.mergeNewSnapshot(
                    snapshot,
                    effects,
                    propertiesDiff
                );
    ...
    function directive2(name, callback) {
        on(
            "directive.init",
            ({ el, component, directive: directive3, cleanup: cleanup3 }) => {
    ...
    function src_default5(Alpine3) {
        Alpine3.directive(
            ...
            (
                ...
                { evaluateLater: evaluateLater2, cleanup: cleanup3 }
            ) => {
    ...
    on("element.init", ({ el, component }) => {
        ...
        if (directives2.missing("submit")) return;
            ...
            if (use === "replace") {
                ...
                let forgetCommitHandler = on(
                    ...
                    ({ component: component2, succeed }) => {
                        ...
                        succeed(() => {
                            let afterValue = dataGet(
                                component2.canonical,
                                name
                            );
                            if (
    ...
    directive2(
        "transition",
        ({ el, directive: directive3, component, cleanup: cleanup3 }) => {
    ...
    on(
        "directive.init",
        ({ el, directive: directive3, cleanup: cleanup3, component }) => {
            if (
                [
                    "snapshot",
                    "effects",
    ...
    directive2(
        "offline",
        ({ el, directive: directive3, cleanup: cleanup3 }) => {
            let setOffline = () =>
