        ...
        (b.prototype = {
            ...
            init: function (t, n) {
                ...
                (this.$element = d(t)),
                    ...
                    ).css("background-color", n.overlayColor)),
                    (this.$navigate = d(
                        '<div class="' +
                            c +
                            '-navigate"><div class="' +
                    ...
                    if (
                        (s.$element
                            ...
                            .on(
                                ...
                                function (t) {
                                    t.preventDefault();
                                    t = d(t.currentTarget).attr(
                                        "data-" + c + "-transitionOut"
                                    );
                                    void 0 !== t
                                        ? s.close({ transition: t })
                                        : s.close();
                                }
                            ),
                        s.$element
                            ...
                            : (this.$element.attr(
                              ...
                              this.$element.one(v, function () {
                                  i.$element.hasClass(e) &&
                                      i.$element
                                          .removeClass(e + " transitionOut")
                                          .hide(),
                                      i.$overlay
                                          .removeClass(
                                              i.options.transitionOutOverlay
                                          )
                                          .remove(),
                                      i.$navigate
                                          .removeClass("fadeOut")
            ...
            destroy: function () {
                ...
                this.$element.trigger(t),
                    ...
                    this.$element.html(
                        this.$element.find("." + c + "-content").html()
                    ),
            ...
            setSubtitle: function (t) {
                "" === t
                    ? (this.$header.find("." + c + "-header-subtitle").remove(),
                      this.$header.addClass(c + "-noSubtitle"))
                    : (0 ===
                          this.$header.find("." + c + "-header-subtitle")
                              .length &&
                          this.$header.append(
                              '<p class="' + c + '-header-subtitle"></p>'
                          ),
            ...
            recalcWidth: function () {
                ...
                this.$element.css("max-width", this.options.width),
                    f() &&
                        (1 <
                            (t = this.options.width).toString().split("%")
                                .length && (t = this.$element.outerWidth()),
            ...
            recalcLayout: function () {
                var t = this,
                    ...
                    o = this.$element.find("." + c + "-content")[0]
                        .scrollHeight,
                ...
                f() &&
                    ...
                    (this.state != m && this.state != p) ||
                        (!0 === this.options.iframe &&
                            (e <
                                this.options.iframeHeight +
                                    this.headerHeight +
                                    l || !0 === this.isFullscreen
                                ? this.$element
                                      .find("." + c + "-iframe")
                                      .css(
                                          "height",
                                          e - (this.headerHeight + l)
                                      )
                                : this.$element
                                      .find("." + c + "-iframe")
                                      .css(
                        ...
                        !1 === this.isFullscreen &&
                        this.$element.width() >= h.width()
                            ? this.$element
                                  .find("." + c + "-button-fullscreen")
                                  .hide()
                            : this.$element
                                  .find("." + c + "-button-fullscreen")
                                  .show(),
                        ...
                        !1 === this.isFullscreen &&
                            (e =
                                e -
                                (g(this.options.top) || 0) -
                                (g(this.options.bottom) || 0)),
                        e < s
                            ? (0 < this.options.top &&
